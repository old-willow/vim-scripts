...
" gandalf: changed to distinguish all types of strings.
" Triple-quoted strings can contain doctests.
syn region  pythonStringD
      \ start=+[uU]\=\z(["]\)+ end="\z1" skip="\\\\\|\\\z1"
      \ contains=pythonEscape,@Spell
syn region  pythonStringS
      \ start=+[uU]\=\z([']\)+ end="\z1" skip="\\\\\|\\\z1"
      \ contains=pythonEscape,@Spell
syn region  pythonStringT
      \ start=+[uU]\=\z('''\|"""\)+ end="\z1" keepend
      \ contains=pythonEscape,pythonSpaceError,pythonDoctest,@Spell
syn region  pythonRawStringD
      \ start=+[uU]\=[rR]\z(["]\)+ end="\z1" skip="\\\\\|\\\z1"
      \ contains=@Spell
syn region  pythonRawStringS
      \ start=+[uU]\=[rR]\z([']\)+ end="\z1" skip="\\\\\|\\\z1"
      \ contains=@Spell
syn region  pythonRawStringT
...
" gandalf edited: Jan 4, 2013
syn match  pythonBraces "[{}\[\]]"
syn match  pythonParens "[()]"
syn match  pythonOperators "=\{1,2}\|!=\|<\|>\|<=\|>=\|+\|-\|/\|*\|+=\|-=\|/=\|*=\|!\|%"
syn match  pythonPunctuations "[:;,.]"
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  " gandalf changed: Jan 4, 2013
  HiLink pythonStringD		StringD
  HiLink pythonStringS		StringS

  HiLink pythonStringT		DocString
  HiLink pythonRawStringD	StringD
  HiLink pythonRawStringS	StringS
  HiLink pythonRawStringT	DocString

  HiLink pythonSelf         Include

  " Some gandalf symbols:
  HiLink pythonBraces       pyBraces
  HiLink pythonParens       pyParens
  HiLink pythonOperators    pyOperators
  HiLink pythonPunctuations pyPunct
...
" Including Django syntax highlight.
if exists("g:django_python")
    if g:django_python == 1
        runtime! syntax/django_syntax.vim
    endif
endif
