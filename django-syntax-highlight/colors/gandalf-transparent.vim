...
" Last Changed: April 24, 2014
" Description: This is constantly work in progress.
"              The same color scheme as gandalf but with transparent background
...
""" vimdiff
hi diffAdd      ctermfg=fg  guifg=fg      ctermbg=151 guibg=#afdfaf
"hi diffDelete   ctermfg=bg  guifg=bg      ctermbg=186 guibg=#dfdf87 cterm=none gui=none
hi diffDelete   ctermfg=fg  guifg=fg      ctermbg=246 guibg=#949494 cterm=none gui=none
hi diffChange   ctermfg=fg  guifg=fg      ctermbg=181 guibg=#dfafaf
hi diffText     ctermfg=fg  guifg=fg      ctermbg=174 guibg=#df8787 cterm=none gui=none
