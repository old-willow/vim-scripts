...
" jQuery
  ...
  syntax keyword jQueryCssKeyWords        addClass after append appendTo attr before clone css detach empty hasClass height html innerHeight innerWidth insertAfter insertBefore offset offsetParent outerHeight outerWidth position prepend prependTo prop remove removeAttr removeClass removeProp replaceAll replaceWidth scrollLeft scrollTop text val width wrap wrapAll wrapInner
